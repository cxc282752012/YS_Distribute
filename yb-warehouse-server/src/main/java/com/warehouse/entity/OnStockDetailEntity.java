...
public class OnStockDetailEntity {
    private Integer onStockDetailId;
    ...
    public Integer getOnStockDetailId() {
        return onStockDetailId;
    }

    public void setOnStockDetailId(Integer onStockDetailId) {
        this.onStockDetailId = onStockDetailId;
    }
